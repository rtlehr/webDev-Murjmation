...
/**
	 ...
	 *
	 * @method getCurrentGroupName
	 */

	Murjmation.prototype.getCurrentGroupName = function() {
...
/**
 * Get the total number of pages in a group
 *
 * @method getTotalGroupPages
 */

Murjmation.prototype.getTotalGroupPages = function() {

	return this.currentGroup.totalPages();

};

	/**
	 * Gets the number of subgroups within a group 
	 *
	 * @method getTotalNumberOfGroups
	 */

	Murjmation.prototype.getTotalNumberOfGroups = function() {

		return murjmation.groups.length;
...
(function(window) {
	...
	Transitions = function(configure) {
